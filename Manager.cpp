...
template <class T>
Manager<T>::Manager(std::string newID, std::string type, Account userAccount): Sales<T>(newID, type, userAccount){}      //call parent class constructor 
